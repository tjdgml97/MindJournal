                  ...
                  Row(
                    ...
                    children: [
                      ...
                      IconButton(onPressed: (){
                        Navigator.pushNamed(context, '/step1page');
                          ...
                          children: [
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                IconButton(onPressed: (){
                                  Navigator.pushNamed(context, '/step2page');
                                }, icon: Icon(Icons.navigate_next)),
                              ],
                            ),
                            //TextButton(onPressed: (){ Navigator.pushNamed(context, '/step1page');}, child:Text("시작")),
                          ...
                          children: [
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                IconButton(onPressed: (){
                                  Navigator.pushNamed(context, '/step3page');
                                }, icon: Icon(Icons.navigate_next)),
                              ],
                            ),
                            //TextButton(onPressed: (){ Navigator.pushNamed(context, '/step1page');}, child:Text("시작")),
                          ...
                          children: [
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                IconButton(onPressed: (){
                                  Navigator.pushNamed(context, '/step4page');
                                }, icon: Icon(Icons.navigate_next)),
                              ],
                            ),
                            //TextButton(onPressed: (){ Navigator.pushNamed(context, '/step1page');}, child:Text("시작")),
